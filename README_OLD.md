...
> **Note:** Package is ready for PyPI publication. Installation via pip will be available in the next release.
...
For developers integrating AuthMCP Gateway into applications:

- **[API Documentation](docs/API.md)** - Complete API reference with usage examples
  - Authentication methods (OAuth2, Password Grant)
